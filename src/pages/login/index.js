                        ...
                        <div>
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5 flex gap-3">
                                    <button className="block w-full max-w-xs mx-auto bg-indigo-500 focus:shadow-lg hover:shadow-lg shadow-black  translate-y-[-0.25em] duration-500  text-white rounded-lg px-3 py-3 font-semibold">Login</button>
                                    <button className="w-full max-w-xs mx-auto bg-white  text-black rounded-lg px-3 py-3 font-semibold flex justify-center focus:shadow-lg hover:shadow-lg shadow-black  translate-y-[-0.25em] duration-500" onClick={signInGoogle} ><FcGoogle size={25} className="pr-1" /> Google</button>
                                </div>
                                
                            </div>
                            <div className='flex justify-center'>
                                <Link href="/register">
                                    <span className="text-gray-600 font-bold mt-12 md:mt-24 cursor-pointer hover:text-indigo-500 duration-500">Create a acount ?</span>
                                </Link>
                            </div>
                        </div>
                    </div>
