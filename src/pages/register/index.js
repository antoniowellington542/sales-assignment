                  ...
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="relative p-6 flex-auto">
                      <p className="my-4 text-slate-500 text-lg leading-relaxed">
                        {sucess ? "Congratulations! Your account is created!": "User Already Exists!"}
                      </p>
                    </div>
                ...
                <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{maxWidth:'1000px'}}>
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                            ...
                            <div className="w-full px-3 mb-5">
                                <button className="flex justify-center w-full max-w-xs mx-auto border border-gray-400 bg-white  text-black rounded-lg px-3 py-3 font-semibold shadow-sm hover:shadow-black" onClick={registerGoogle}><FcGoogle size={25} className="pr-1" />Google</button>
                            </div>
                        </div>
                    </div>
                </div>
