        ...
        <div>
            <nav className="p-5 bg-white shadow md:flex md:items-center md:justify-between">
                <div className="flex align-middle">
                    ...
                    <ul className={`md:flex md:items-center z-[-1] md:z-auto md:static absolute bg-white w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-4 md:opacity-100 ${open == true ? 'top-[50px]' : 'top-[-400px]'} transition-all ease-in duration-1000`}>
